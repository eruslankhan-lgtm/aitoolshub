...
const tools = [
  {
    ...
    price: "$29/mo", tags: ["YouTube", "SEO", "Video AI"], affiliateLink: "https://tubemagic.com/ds#aff=eruslankhanf027"
  },
  {
    ...
    price: "~$27 (One-Time)", tags: ["SEO", "Marketing", "Ebooks"], affiliateLink: "https://41ebookset3.neoseotools.com/#aff=eruslankhanf027"
  },
  {
    ...
    price: "€29.99 (One-Time)", tags: ["Writing", "AI", "Self-Publishing"], affiliateLink: "https://www.aibookwriter.de/en#aff=eruslankhanf027"
  },
  {
    ...
    price: "One-Time Fee", tags: ["No-Code", "Software", "Marketing"], affiliateLink: "https://www.digistore24.com/redir/467549/eruslankhanf027/"
  },
  {
    ...
    price: "$29/mo", tags: ["No-Code", "Whitelabel", "SaaS"], affiliateLink: "https://writelytic.com/#aff=eruslankhanf027"
  }
];
            ...
            <article key={tool.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {tool.tags.map((tag, i) => (
                    <span key={i} className="bg-blue-50 text-blue-600 text-xs px-3 py-1 rounded-full">{tag}</span>
                  ))}
                </div>
                ...
                <div className="space-y-3">
                  <a href={tool.affiliateLink} target="_blank" rel="sponsored nofollow noopener"
